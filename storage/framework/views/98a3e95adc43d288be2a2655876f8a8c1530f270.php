...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <!--<li>
                    <a href="<?php echo e(route('admin.timedays')); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('admin.times')); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('admin.days')); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('admin.timenotavailables')); ?>">
                        <i class="fa  fa-clock-o"></i>
                        <span>
                            Waktu Berhalangan
                        </span>
            ...
            <li>
                <a href="<?php echo e(route('admin.lecturers')); ?>">
            ...
            <li>
                <a href="<?php echo e(route('admin.teachs')); ?>">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-file-archive-o"></i> <span>Jadwal</span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
