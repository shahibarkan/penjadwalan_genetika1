...
<div class="form-group">
    ...
    <?php echo Form::select('role', [
        'admin' => 'admin',
        'user' => 'user',
    ], null, ['class' => 'form-control select2 to-select', 'id' => 'role', 'required','placeholder' => 'Pilih role']); ?>

    <label id="role-error" class="error" for="role" style="display: none;">This field is required.</label>
</div>
<div class="form-group">
    <label>
        Email
