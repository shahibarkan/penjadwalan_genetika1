                        ...
                        <?php echo Form::open(['role' => 'form', 'route' => 'admin.courses', 'method' =>'get']); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo Form::text('searchcode', Input::get('searchcode')?: null, ['class' => 'form-control', 'placeholder' => 'Mencari Berdasarkan Kode Pelajaran']); ?>

                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo Form::text('searchname', Input::get('searchname')?: null, ['class' => 'form-control', 'placeholder' => 'Mencari Berdasarkan Nama Pelajaran']); ?>
