<script type="text/javascript">
    ...
    $( "#form-register").validate({
      rules: {
        ...
        emailuser : {
            remote: {
                url: "<?php echo e(route('ajax.user.email')); ?>",
                type: "GET",
                data: {
        ...
        emaillecturer : {
            remote: {
                url: "<?php echo e(route('ajax.lecturer.email')); ?>",
                type: "GET",
                data: {
        ...
        nidnlecturer : {
            remote: {
                url: "<?php echo e(route('ajax.lecturer.nidn')); ?>",
                type: "GET",
                data: {
        ...
        namecourses : {
            remote: {
                url: "<?php echo e(route('ajax.course.name')); ?>",
                type: "GET",
                data: {
        ...
        code_courses : {
            remote: {
                url: "<?php echo e(route('ajax.course.code')); ?>",
                type: "GET",
                data: {
        ...
        code_rooms : {
            remote: {
                url: "<?php echo e(route('ajax.room.code')); ?>",
                type: "GET",
                data: {
        ...
        namerooms : {
            remote: {
                url: "<?php echo e(route('ajax.room.name')); ?>",
                type: "GET",
                data: {
        ...
        // courses : {
        //     remote: {
        //         url: "<?php echo e(route('ajax.teach.courses')); ?>",
        //         type: "GET",
        //         data: {
