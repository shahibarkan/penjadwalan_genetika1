...
class GenetikController extends Controller
{
    ...
    public function excel($id)
    {
        ...
        $pdf = \PDF::loadView('admin.genetik.export', compact('schedules'));
        return $pdf->download('Algoritma Genetika.pdf');
    }

    // make function downloadExcel
    public function downloadExcel()
    {
        // make simple download
        return Excel::create('Algoritma Genetika', function ($excel)
        {
            $excel->sheet('Genetika', function ($sheet)
            {
                $sheet->loadView('admin.genetik.export');
            });
        })->export('xls');
    ...
    // make function pdfdownload from laravel-dompdf
