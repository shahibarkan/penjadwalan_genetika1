                        ...
                        {!! Form::open(['role' => 'form', 'route' => 'admin.generates.submit', 'id' => 'form-register', 'method' => 'get']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  {!! Form::text('kromosom', Input::get('kromosom'), ['class' => 'form-control required', 'maxlength' => '100', 'placeholder' => 'Masukkan Nilai kromosom ', 'id' => 'kromosom']) !!}
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                {!! Form::text('generasi', Input::get('generasi'), ['class' => 'form-control required', 'maxlength' => '100', 'placeholder' => 'Masukkan Nilai Generasi ', 'id' => 'generasi']) !!}
                                  {!! Form::hidden('tabs', Input::get('tabs') ? Input::get('tabs') : 1, ['id' => 'tabs']) !!}
